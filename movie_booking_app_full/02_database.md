# 🗄️ Database - SQLite (database_helper.dart)
...
- Cung cấp instance database cho toàn app
...
class DatabaseHelper {
  ...
  Future<void> _insertSeedData(Database db) async {
    ...
    await db.insert('movies', {
      ...
      'genre': 'Hành động',
      'rating': 4.8,
      'image_path': 'https://image.tmdb.org/t/p/w500/or06FN3Dka5tукатурq76Q6z0Nb8i.jpg',
...
```
┌──────────┐     ┌──────────────┐     ┌──────────┐
│  users   │     │   bookings   │     │ cinemas  │
│──────────│     │──────────────│     │──────────│
│ id (PK)  │     │ id (PK)      │     │ id (PK)  │
│ name     │     │ movieTitle   │     │ name     │
│ email    │     │ cinema       │     │ address  │
│ password │     │ cinemaHall   │     │ phone    │
│ role     │     │ seats        │     │ totalHalls│
│ city     │     │ totalPrice   │     └──────────┘
│ district │     │ status       │
│ phone    │     └──────────────┘
└──────────┘
